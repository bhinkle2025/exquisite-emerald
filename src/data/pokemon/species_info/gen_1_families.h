...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_REGENERATOR, ABILITY_CHLOROPHYLL },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK},
                                {EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLA,CONDITIONS({IF_IN_MAP, MAP_FIERY_PATH})},
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                {EVO_LEVEL, 0, SPECIES_WEEZING_GALAR, CONDITIONS({IF_IN_MAP, MAP_RUSTURF_TUNNEL})}),
    },
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                {EVO_LEVEL, ITEM_DUSK_STONE, SPECIES_UMBREON}
                            #endif
                            #if P_GEN_4_CROSS_EVOS

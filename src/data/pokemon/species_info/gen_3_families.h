...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_RECKLESS, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_DAMP, ABILITY_STAMINA },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SPEED_BOOST, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLUE,

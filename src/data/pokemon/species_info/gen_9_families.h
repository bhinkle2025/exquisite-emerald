...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_PICKPOCKET, ABILITY_PROTEAN },
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_UNAWARE, ABILITY_PUNK_ROCK },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_OWN_TEMPO, ABILITY_MOXIE },
    ...
    [SPECIES_FINIZEN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_PALAFIN_ZERO},
                                {EVO_ITEM, ITEM_WATER_STONE, SPECIES_PALAFIN_ZERO}),
    },

...
{
    {COMPOUND_STRING("BULBASAUR{CLEAR_TO 0x48}3,000 COINS")},
    {COMPOUND_STRING("CHARMANDER{CLEAR_TO 0x48}3,000 COINS")},
    {COMPOUND_STRING("SQUIRTLE{CLEAR_TO 0x48}3,000 COINS")},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_Fossil[] =
{
    ...
    {COMPOUND_STRING("JAW FOSSIL")},
    {COMPOUND_STRING("SAIL FOSSIL")},
    {gText_Exit},
};

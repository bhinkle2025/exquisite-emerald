...
const u8 gText_XNatureObtainedInWonderTrade[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nobtained in a WONDER TRADE.");
...
const u8 gText_WonderOTName[] = _("WONDER");
